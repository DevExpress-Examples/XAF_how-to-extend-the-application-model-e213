...
Namespace ExtendModel.Web
	Partial Public Class ExtendModelAspNetApplication
		...
		Private Sub ExtendModelAspNetApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
			e.Updater.Update()
			e.Handled = True
		End Sub
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.ExtendModelAspNetApplication_DatabaseVersionMismatch);
